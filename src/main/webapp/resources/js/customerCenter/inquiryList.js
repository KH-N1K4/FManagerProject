        ...
        success: (map) => {
            if (map != null) {
                ...
                if(map.inquiryList.length != 0){ // 게시글이 존재할 때
                    ...
                    a4.setAttribute("href", "/userInquiryList?cp=" +map.pagination.nextPage+ "&optionVal="+map.optionVal);
                    ...
                    a5.setAttribute("href", "/userInquiryList?cp=" +map.pagination.maxPage+ "&optionVal="+map.optionVal);
