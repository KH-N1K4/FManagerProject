const mainCategoryNoVar = mainCategoryNo;
console.log(mainCategoryNoVar);
        ...
        $.ajax({
            ...
            success:(map)=>{
              ...
              //   a1.setAttribute('href', "/manager/memberList?cp=1"+"&value="+value);
                a1.setAttribute('href', "/category/"+map.mainCategoryNo+"/"+map.thirdCategoryNo+"?cp=1");
              ...
              //   a2.setAttribute("href", "/manager/memberList?cp=" + map.pagination.prevPage+"&value="+value);
                a2.setAttribute("href", "/category/"+map.mainCategoryNo+"/"+map.thirdCategoryNo+"?cp=" + map.pagination.prevPage);
                ...
                for (i = map.pagination.startPage; i <= map.pagination.endPage; i++) {
                    ...
                    if (i == map.pagination.currentPage) {
                      ...
                      //   a3.setAttribute("href", "/manager/memberList?cp=" + i+"&value="+value);
                        a3.setAttribute("href", "/category/"+map.mainCategoryNo+"/"+map.thirdCategoryNo+"?cp=" + i);
                        a3.appendChild(document.createTextNode(i));
                        li3.append(a3);
                        pagination.append(li3);
                    }
              ...
              //   a4.setAttribute("href", "/manager/memberList?cp=" + map.pagination.nextPage+"&value="+value);
                a4.setAttribute("href", "/category/"+map.mainCategoryNo+"/"+map.thirdCategoryNo+"?cp=" + map.pagination.nextPage);
              ...
              //   a5.setAttribute("href", "/manager/memberList?cp=" + map.pagination.maxPage+"&value="+value);
                a5.setAttribute("href", "/category/"+map.mainCategoryNo+"/"+map.thirdCategoryNo+"?cp=" + map.pagination.maxPage);
