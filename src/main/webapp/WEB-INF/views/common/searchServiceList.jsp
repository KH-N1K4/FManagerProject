                        ...
                        <div id="imageContent">
                                <c:forEach var="service" items="${serviceList }">
                                    <div>
                                        ...
                                        <div id="image">
                                            <div>
                                                <img src="${service.serviceFilePath2 }"> <span class="like-area"> <c:if test="${empty loginMember }">
                                            ...
                                            <a href="/service/${service.serviceNo }" class="imageTitle"> <span class="aaa" style="font-size: 16px;">${service.serviceTitle }</span> <span class="imageOthers aaa">${service.serviceSummary }</span>
                                                <span class="imageOthers" style="margin-bottom: 0px; text-align: end; font-size: 16px;">${service.servicePriceString} 원</span> <span class="imageOthers right"><strong>평점</strong> <strong>★
                                                        ${service.reviewPoint}</strong> </span> <span class="imageOthers right"><strong>판매수</strong> <strong>${service.sellCount} 회</strong></span>
                                            </a>
