...
CREATE SEQUENCE SEQ_INQUIRY_TYPE_NO NOCACHE;
...
CREATE SEQUENCE SEQ_MEMBER_REPORT_NO NOCACHE; -- 회원 신고 번호
CREATE SEQUENCE SEQ_MEMBER_REPORT_FILE_NO NOCACHE; -- 회원 신고 첨부파일 번호