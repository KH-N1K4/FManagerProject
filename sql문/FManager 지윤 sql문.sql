...
SELECT SEQ_CHAT_NO.NEXTVAL FROM DUAL;--시퀀스 되돌리기기
ALTER SEQUENCE SEQ_CHAT_NO INCREMENT BY -2;
ALTER SEQUENCE SEQ_CHAT_NO INCREMENT BY 1;
...
SELECT SERVICE_NO, MAIN_CATEGORY_NO,
	...
	NVL(SALE_COUNT,0) SALE_COUNT,NVL(REVIEW_POINT,0) REVIEW_POINT,REQUEST_FILE_PATH,SERVICE_PRICE
